      ...
      <div className="border-t border-gray-200 bg-white px-6 py-4 shadow-lg">
        <form onSubmit={handleSendMessage} className="flex gap-3">
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 disabled:opacity-50 text-white p-3 rounded-full transition-all shadow-md flex items-center justify-center"
          >
